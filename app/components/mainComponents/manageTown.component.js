System.register(['angular2/core', 'angular2/router', "../../services/townService.component", "../../models/mainTown", "../../models/bestuur", "../../models/politicusType", "../subComponents/nav/menu.component", "../subComponents/input/townSelector.component"], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, router_1, townService_component_1, mainTown_1, bestuur_1, politicusType_1, menu_component_1, townSelector_component_1;
        ...
        execute: function() {
            ManageTownComponent = (function () {
                function ManageTownComponent(_routeParams, _townService, _router) {
                    ...
                    this.newBestuur = new bestuur_1.Bestuur("");
                ...
                ManageTownComponent = __decorate([
                    core_1.Component({
                        ...
                        directives: [router_1.ROUTER_DIRECTIVES, townSelector_component_1.TownSelectorComponent, menu_component_1.NavigationMenuComponent]
                    }), 
