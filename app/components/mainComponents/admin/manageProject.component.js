System.register(['angular2/core', 'angular2/router', "../../../pipes/keysPipe", "../../../services/projectService.component", "../../../models/inspraakNiveau", "../../../models/project", "../../../models/projectScenario"], function(exports_1) {
            ...
            ManageProjectComponent = (function () {
                function ManageProjectComponent(_routeParams, _projectService, _router, injector) {
                    ...
                    this.submit = function () {
                        ...
                        _this._projectService.putProject(_this.project).subscribe(function (id) { return _this.id = id; }, function (err) { return _this.errorMessage2 = err; });
