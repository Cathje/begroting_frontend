System.register(['angular2/core', 'angular2/router', './manageData.component', './manageProject.component', './manageTown.component', "./addInformation.component"], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, router_1, manageData_component_1, manageProject_component_1, manageTown_component_1, addInformation_component_1;
    var AdminRouter;
    return {
        setters:[
            function (core_1_1) {
            ...
            function (addInformation_component_1_1) {
                addInformation_component_1 = addInformation_component_1_1;
            }],
        execute: function() {
            AdminRouter = (function () {
                ...
                AdminRouter = __decorate([
                    ...
                    router_1.RouteConfig([
                        ...
                        { path: '/addInformation', name: 'AddInformation', component: addInformation_component_1.AddInformationComponent }
                    ]), 
