    ...
    return {
        ...
        execute: function() {
            OverviewComponent = (function () {
                function OverviewComponent(_projectService, _townService, _begrotingService, injector, _routeParams) {
                    var _this = this;
                    ...
                    this.income = []; //TODO create a webapi that shows the income categories
                    ...
                    sessionStorage.setItem("currentTown", injector.parent.parent.get(router_1.RouteParams).get('town'));
                ...
                OverviewComponent = __decorate([
                    ...
                    __metadata('design:paramtypes', [projectService_component_1.ProjectService, townService_component_1.TownService, begrotingService_1.BegrotingService, core_1.Injector, router_1.RouteParams])
                ], OverviewComponent);
