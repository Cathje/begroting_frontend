System.register(['angular2/core', 'angular2/http', 'angular2/router', './../../subComponents/graphs/sunburst.component', "../../../services/begrotingService", "../../../mockData/mock-categories", "../../../models/bestuurType", './../../subComponents/input/selector.component'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, http_1, router_1, sunburst_component_1, begrotingService_1, mock_categories_1, bestuurType_1, selector_component_1;
    ...
    return {
        ...
        execute: function() {
            ExpensesComponent = (function () {
                function ExpensesComponent(_begrotingService, http, params, injector, _router) {
                    var _this = this;
                ...
                ExpensesComponent = __decorate([
                    core_1.Component({
                        ...
                        directives: [sunburst_component_1.SunburstComponent, router_1.ROUTER_DIRECTIVES, selector_component_1.SelectorComponent],
                        providers: [begrotingService_1.BegrotingService],
                        styles: ["\n    li {\n        list-style: none;\n        display: flex;\n        align-items: center;\n\n    }\n\n    li .glyphicon {\n        font-size: 0.8em;\n        color: white;\n    }\n\n    .colorblock {\n        margin: 5px;\n        padding: 8px;\n        border-radius: 5px;\n    }\n\n    .button-menu {\n        position: absolute;\n        top: 0;\n        left: 0;\n        display:flex;\n    }\n\n    .dropdown-menu a{\n        color:black !important;\n    }\n\n    .legend {\n        border: 1px solid lightgray;\n        padding: 10px;\n    }\n\n    .main-content {\n        padding-top: 10px;\n        display: flex;\n        align-items: center;\n    }\n"]
                    }), 
                    __metadata('design:paramtypes', [begrotingService_1.BegrotingService, http_1.Http, router_1.RouteParams, core_1.Injector, router_1.Router])
                ], ExpensesComponent);
