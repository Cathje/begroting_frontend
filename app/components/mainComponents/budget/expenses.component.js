System.register(['angular2/core', './../../../services/townService.component.js', 'angular2/http', 'angular2/router', './../../subComponents/input/townSelector.component.js', './../../subComponents/input/editableField.component.js', "../../../models/mainTown.js", './../../subComponents/graphs/sunburst.component.js', "../../../services/begrotingService.js", "../../../mockData/mock-categories.js", "../../../models/bestuurType.js", "../../../pipes/keysPipe.js"], function(exports_1) {
    ...
    var core_1, townService_component_js_1, http_1, router_1, townSelector_component_js_1, editableField_component_js_1, mainTown_js_1, sunburst_component_js_1, begrotingService_js_1, mock_categories_js_1, bestuurType_js_1, keysPipe_js_1;
    ...
    return {
        setters:[
            ...
            function (mock_categories_js_1_1) {
                mock_categories_js_1 = mock_categories_js_1_1;
            },
            function (bestuurType_js_1_1) {
                bestuurType_js_1 = bestuurType_js_1_1;
            },
        ...
        execute: function() {
            ExpensesComponent = (function () {
                function ExpensesComponent(_townService, _begrotingService, http, params, injector, _router) {
                    ...
                    this.categories = [];
                    this.headCategories = mock_categories_js_1.categories;
                    this.types = bestuurType_js_1.BestuurType;
                    ...
                    console.log(bestuurType_js_1.BestuurType[1]);
