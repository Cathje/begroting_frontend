System.register(['angular2/core', 'angular2/router', "../../../pipes/keysPipe", "../../../services/projectService.component", "../../../models/inspraakNiveau", "../../../models/project", "../../../models/projectScenario", '../../../directives/styled'], function(exports_1) {
    ...
    return {
        ...
        execute: function() {
            ManageProjectComponent = (function () {
                function ManageProjectComponent(_projectService, injector) {
                    var _this = this;
                    ...
                    this.submit = function () {
                        ...
                        _this._projectService.postProject(_this.NewProject).subscribe(function (id) { return _this.id = id; }, function (err) { return _this.errorMessage = err; });
                ...
                ManageProjectComponent = __decorate([
                    ...
                    __metadata('design:paramtypes', [projectService_component_1.ProjectService, core_1.Injector])
