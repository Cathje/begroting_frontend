System.register(['angular2/core', './../../services/townService.component.js', 'angular2/router', './../subComponents/input/townSelector.component.js', './../subComponents/input/editableField.component.js', './../subComponents/nav/menu.component.js', "../../models/mainTown.js", './../subComponents/graphs/sunburst.component.js', "../../services/begrotingService.js", "../../services/ActieService.js"], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, townService_component_js_1, router_1, router_2, townSelector_component_js_1, editableField_component_js_1, menu_component_js_1, mainTown_js_1, sunburst_component_js_1, begrotingService_js_1, ActieService_js_1;
    var TownComponent;
    return {
        setters:[
            function (core_1_1) {
        ...
        execute: function() {
            TownComponent = (function () {
                function TownComponent(_townService, _begrotingService, _routeParams) {
                    var _this = this;
                    this._townService = _townService;
                    this._routeParams = _routeParams;
                    this.title = 'Gemeente - home';
                    this.name = "";
                    this.mainTown = new mainTown_js_1.MainTown("", "", 0); //opm: moet geïnitialiseerd zijn, anders werkt ngModel niet
                ...
                TownComponent = __decorate([
                    core_1.Component({
                        ...
                        directives: [router_2.ROUTER_DIRECTIVES, townSelector_component_js_1.TownSelectorComponent, menu_component_js_1.NavigationMenuComponent, editableField_component_js_1.EditableFieldComponent, sunburst_component_js_1.SunburstComponent],
                    ...
                    __metadata('design:paramtypes', [(typeof (_a = typeof townService_component_js_1.TownService !== 'undefined' && townService_component_js_1.TownService) === 'function' && _a) || Object, (typeof (_b = typeof begrotingService_js_1.BegrotingService !== 'undefined' && begrotingService_js_1.BegrotingService) === 'function' && _b) || Object, router_1.RouteParams])
                ], TownComponent);
