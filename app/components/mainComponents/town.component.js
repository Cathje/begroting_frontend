System.register(['angular2/core', './../../services/townService.component', 'angular2/router', './../subComponents/input/townSelector.component', './../subComponents/input/editableField.component', "../../models/mainTown", './../subComponents/graphs/sunburst.component', "../../services/begrotingService", "../../services/ActieService"], function(exports_1) {
    ...
    return {
        ...
        execute: function() {
            TownComponent = (function () {
                ...
                TownComponent.prototype.onResize = function (event) {
