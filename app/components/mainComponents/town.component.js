System.register(['angular2/core', './../../services/townService.component', 'angular2/router', './../subComponents/input/townSelector.component', './../subComponents/input/editableField.component', './../subComponents/nav/menu.component', "../../models/mainTown", './../subComponents/graphs/sunburst.component', "../../services/begrotingService", "../../services/ActieService"], function(exports_1, context_1) {
    ...
    var core_1, townService_component_1, router_1, router_2, townSelector_component_1, editableField_component_1, menu_component_1, mainTown_1, sunburst_component_1, begrotingService_1, ActieService_1;
    var TownComponent;
    return {
        setters:[
            function (core_1_1) {
        ...
        execute: function() {
            TownComponent = (function () {
                function TownComponent(_townService, _begrotingService, _routeParams, _actieService) {
                    var _this = this;
                ...
                TownComponent = __decorate([
                    core_1.Component({
                        ...
                        directives: [router_2.ROUTER_DIRECTIVES, townSelector_component_1.TownSelectorComponent, menu_component_1.NavigationMenuComponent, editableField_component_1.EditableFieldComponent, sunburst_component_1.SunburstComponent],
                    ...
                    __metadata('design:paramtypes', [townService_component_1.TownService, begrotingService_1.BegrotingService, router_1.RouteParams, ActieService_1.ActieService])
                ], TownComponent);
