System.register(['angular2/core', 'angular2/router', "../../../services/projectService.component", "../../../models/reactieOpVoorstel", '../../../directives/styled', "../../subComponents/graphs/sunburst.component", "../../../services/begrotingService"], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, router_1, projectService_component_1, reactieOpVoorstel_1, styled_1, sunburst_component_1, begrotingService_1;
    ...
    return {
        ...
        execute: function() {
            PropositionsComponent = (function () {
                function PropositionsComponent(_routeParams, _projectService, _begrotingService) {
                    var _this = this;
                    ...
                    this.categoriesBegroting = [];
                    this.onCircleClick = function () {
                    };
                    _projectService.getProjects("Gent").subscribe(function (pr) {
                        _this.projects = pr;
                        console.log(pr);
                    ...
                    this._begrotingService.getGemeenteCategorieen(2020, "Gent")
                        ...
                        _this.categoriesBegroting = finan;
                ...
                PropositionsComponent = __decorate([
                    core_1.Component({
                        ...
                        providers: [
                            projectService_component_1.ProjectService, begrotingService_1.BegrotingService
                        ],
                        directives: [styled_1.StyledDirective, sunburst_component_1.SunburstComponent],
                        styles: ["\n        .panel-heading {\n            background-color: lightgray;\n        }\n\n        .approve{\n            background-color: #d0d257 !important;\n            border: none;\n        }\n\n        .disapprove{\n            background-color: #f7baba !important;\n            border: none;\n        }\n\n        tr {\n            display: flex;\n            justify-content: center;\n        }\n\n        td:nth-child(1){\n            flex: 1 1 auto;\n        }\n\n        td:nth-child(2) {\n            display: flex;\n            align-items: center;\n            justify-content: center;\n        }\n\n        .proposition {\n            background-color: #f2f3f8;\n            padding-bottom: 2px;\n            padding-top: 2px;\n            color: black\n        }\n\n        .prop-title {\n            display:flex;\n            align-items: center;\n        }\n\n        .prop-title a {\n            flex: 1 1 auto;\n            color:black !important;\n        }\n\n        .prop-title span {\n            padding:0 5px ;\n        }\n\n        .prop-title i {\n            font-size: 0.8em;\n        }\n\n        .no-padding {\n            padding: 0;\n        }\n\n        .panel-group {\n        margin-bottom: 0\n        }\n\n        .panel-default {\n            border: none;\n        }\n\n        .graphs {\n            display:flex;\n            align-items: center;\n            justify-content:center;\n        }\n\n        .graphs h3 {\n        text-align : center;\n        }\n\n        .graphs > div {\n        padding: 0px 30px;\n        }\n    "]
                    }), 
                    __metadata('design:paramtypes', [router_1.RouteParams, projectService_component_1.ProjectService, begrotingService_1.BegrotingService])
