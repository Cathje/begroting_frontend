        ...
        execute: function() {
            PropositionsComponent = (function () {
                function PropositionsComponent(_routeParams, _projectService) {
                    ...
                    this._projectService.getProjects("Gent").subscribe(function (pr) { return _this.projects = pr; }, function (err) { return _this.errorMessage = "Er zijn geen projecten gevonden voor deze gemeenten"; });
                }
