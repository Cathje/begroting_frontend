      ...
      <p *ngIf="!projects"><i>Er zijn geen projecten gevonden</i></p>
        ...
        <div class="section-content">
            ...
            <tr *ngFor="#voorstel of project.voorstellen">
                ...
                <td>
                <span>Stem: </span><button class="btn btn-primary" (click)="stem(voorstel)"><span class="glyphicon glyphicon-thumbs-up"></span></button>
                </td>
            </tr>
            </tbody>
        </table>
...
export class PropositionsComponent
{
    ...
    stem(v: BegrotingsVoorstel)
    {
        this._projectService.putReactieEnStem(v.Id, "nadya@nadya.be").subscribe((d:any) => this.data = d);
