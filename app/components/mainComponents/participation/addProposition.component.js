    ...
    return {
        ...
        execute: function() {
            AddPropositionComponent = (function () {
                function AddPropositionComponent(_routeParams, _projectService, injector, _begrotingService) {
                    var _this = this;
                    ...
                    this.myTown = injector.parent.parent.parent.parent.get(router_1.RouteParams).get('town');
                    ...
                    this._projectService.getProject(this.year, "Gent")
                        ...
                        _this._projectService.getInspraakitems(_this.year, _this.myTown)
                ...
                AddPropositionComponent.prototype.getBudget = function () {
                    var _this = this;
                    this.errorMessage2 = "";
                    this._begrotingService.getGemeenteCategorieen(this.budgetYear, this.myTown)
                        .subscribe(function (cats) { return _this.categories = cats; }, function (err) { return _this.errorMessage2 = "Er zijn geen categorieën of projecten gevonden voor dit boekjaar."; });
                    this._projectService.getProject(this.year, this.myTown)
                        .subscribe(function (project) {
                        _this.project = project;
                        console.log(project);
                    }, function (err) {
                        _this._projectService.getInspraakitems(_this.budgetYear, _this.myTown)
                            .subscribe(function (cats) { return _this.project = cats; }, function (err) { return _this.errorMessage2 = "Er zijn geen categorieën of projecten gevonden voor dit boekjaar."; });
                    });
                };
                ...
                AddPropositionComponent = __decorate([
                    ...
                    __metadata('design:paramtypes', [router_1.RouteParams, projectService_component_1.ProjectService, core_1.Injector, begrotingService_1.BegrotingService])
