System.register(['angular2/core', './components/mainComponents/home.component.js', './components/mainComponents/town.component.js', './components/mainComponents/project.component.js', './components/mainComponents/addProject.component.js', './components/mainComponents/townBudget.component.js', './components/mainComponents/salary.component.js', 'angular2/router', "angular2/http"], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, home_component_js_1, town_component_js_1, project_component_js_1, addProject_component_js_1, townBudget_component_js_1, salary_component_js_1, router_1, http_1;
    var AppComponent;
    return {
        setters:[
            function (core_1_1) {
            ...
            function (town_component_js_1_1) {
                town_component_js_1 = town_component_js_1_1;
            },
            function (project_component_js_1_1) {
                project_component_js_1 = project_component_js_1_1;
            },
            function (addProject_component_js_1_1) {
                addProject_component_js_1 = addProject_component_js_1_1;
            },
            function (townBudget_component_js_1_1) {
                townBudget_component_js_1 = townBudget_component_js_1_1;
            },
            function (salary_component_js_1_1) {
                salary_component_js_1 = salary_component_js_1_1;
            },
            function (router_1_1) {
                router_1 = router_1_1;
            },
            ...
            AppComponent = (function () {
                ...
                AppComponent = __decorate([
                    ...
                    router_1.RouteConfig([
                        ...
                        { path: '/:town', name: 'MainTown', component: town_component_js_1.TownComponent },
                        { path: '/:town/:projectNumber', name: 'Project', component: project_component_js_1.ProjectComponent },
                        { path: '/:town/addProject', name: 'AddProject', component: addProject_component_js_1.AddProjectComponent },
                        { path: '/townBudget/...', name: 'TownBudget', component: townBudget_component_js_1.TownBudgetComponent },
                        { path: '/:town/salary', name: 'Salary', component: salary_component_js_1.SalaryComponent }
                    ]), 
