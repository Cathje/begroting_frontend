System.register(['angular2/core', 'angular2/router', "angular2/http", './components/mainComponents/homeRouter', "./components/mainComponents/login/login.component", "./components/mainComponents/login/register.component", "./services/townService.component"], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, router_1, http_1, homeRouter_1, login_component_1, register_component_1, townService_component_1;
    var AppComponent;
    return {
        setters:[
            function (core_1_1) {
            ...
            AppComponent = (function () {
                ...
                AppComponent = __decorate([
                    core_1.Component({
                        ...
                        providers: [router_1.ROUTER_PROVIDERS, http_1.HTTP_PROVIDERS, townService_component_1.TownService],
